...
> = () => QueryController<T, Map>;

// Class
export const classRelationMap = {
  classes_level_id_fkey: {
    alias: "educational_level",
    referencedTable: "educational_levels",
    isOneToMany: false,
  },
} as const;

export class ClassController extends QueryController<
  "classes",
  typeof classRelationMap
> {
...
export const useClassesController: UseControllerHook<
  "classes",
  typeof classRelationMap
> = () => {
...
export class CommentController extends QueryController<
  "comments",
  typeof commentRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export const useCommentsController: UseControllerHook<
  "comments",
  typeof commentRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export class CurricularAreaController extends QueryController<
  "curricular_areas",
  typeof curricularAreaRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type CurricularArea = Awaited<
  ReturnType<CurricularAreaController["getById"]>
>;
export type CurricularAreaInsert = Parameters<
  CurricularAreaController["create"]
>[0];
export type CurricularAreaUpdate = Parameters<
  CurricularAreaController["update"]
>[1];

export const useCurricularAreasController: UseControllerHook<
  "curricular_areas",
  typeof curricularAreaRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const disciplineClassRelationMap = {
  discipline_class_area_id_fkey: {
    alias: "curricular_area",
    referencedTable: "curricular_areas",
    isOneToMany: false,
  },
  discipline_class_class_id_fkey: {
    alias: "class",
    referencedTable: "classes",
    isOneToMany: false,
  },
  discipline_class_discipline_id_fkey: {
    alias: "discipline",
...
export class DisciplineClassController extends QueryController<
  "discipline_class",
  typeof disciplineClassRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type DisciplineClass = Awaited<
  ReturnType<DisciplineClassController["getById"]>
>;
export type DisciplineClassInsert = Parameters<
  DisciplineClassController["create"]
>[0];
export type DisciplineClassUpdate = Parameters<
  DisciplineClassController["update"]
>[1];

export const useDisciplineClassController: UseControllerHook<
  "discipline_class",
  typeof disciplineClassRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const disciplineRelationMap = {
  disciplines_curricular_area_id_fkey: {
    alias: "curricular_area",
    referencedTable: "curricular_areas",
    isOneToMany: false,
  },
...
export class DisciplineController extends QueryController<
  "disciplines",
  typeof disciplineRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export const useDisciplinesController: UseControllerHook<
  "disciplines",
  typeof disciplineRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export class DomainController extends QueryController<
  "domains",
  typeof domainRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export const useDomainsController: UseControllerHook<
  "domains",
  typeof domainRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export class EducationalLevelController extends QueryController<
  "educational_levels",
  typeof educationalLevelRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type EducationLevel = Awaited<
  ReturnType<EducationalLevelController["getById"]>
>;
export type EducationLevelInsert = Parameters<
  EducationalLevelController["create"]
>[0];
export type EducationLevelUpdate = Parameters<
  EducationalLevelController["update"]
>[1];

export const useEducationLevelsController: UseControllerHook<
  "educational_levels",
  typeof educationalLevelRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const generalCompetencyRelationMap = {
  general_competencies_discipline_id_fkey: {
    alias: "discipline",
    referencedTable: "disciplines",
    isOneToMany: false,
  },
  general_competencies_level_id_fkey: {
    alias: "educational_level",
    referencedTable: "educational_levels",
    isOneToMany: false,
  },
...
export class GeneralCompetencyController extends QueryController<
  "general_competencies",
  typeof generalCompetencyRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type GeneralCompetency = Awaited<
  ReturnType<GeneralCompetencyController["getById"]>
>;
export type GeneralCompetencyInsert = Parameters<
  GeneralCompetencyController["create"]
>[0];
export type GeneralCompetencyUpdate = Parameters<
  GeneralCompetencyController["update"]
>[1];

export const useGeneralCompetenciesController: UseControllerHook<
  "general_competencies",
  typeof generalCompetencyRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export class GroupMemberController extends QueryController<
  "group_members",
  typeof groupMemberRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export const useGroupMembersController: UseControllerHook<
  "group_members",
  typeof groupMemberRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const groupResourceRelationMap = {
  group_resources_group_id_fkey: {
    alias: "group",
    referencedTable: "groups",
    isOneToMany: false,
  },
  group_resources_resource_id_fkey: {
    alias: "resource",
    referencedTable: "resources",
    isOneToMany: false,
  },
...
export class GroupResourceController extends QueryController<
  "group_resources",
  typeof groupResourceRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type GroupResource = Awaited<
  ReturnType<GroupResourceController["getById"]>
>;
export type GroupResourceInsert = Parameters<
  GroupResourceController["create"]
>[0];
export type GroupResourceUpdate = Parameters<
  GroupResourceController["update"]
>[1];

export const useGroupResourcesController: UseControllerHook<
  "group_resources",
  typeof groupResourceRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export class GroupController extends QueryController<
  "groups",
  typeof groupRelationMap
> {
  constructor(client: TypedSupabaseClient) {
    super(client, "groups", {
      fields: ["*"],
...
export const useGroupsController: UseControllerHook<
  "groups",
  typeof groupRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const resourceCompetencyRelationMap: ForeignKeyRelationMap<"resource_competencies"> =
  {
    resource_competencies_resource_id_fkey: {
      alias: "resource",
      referencedTable: "resources",
      isOneToMany: false,
    },
    resource_competencies_specific_competency_id_fkey: {
      alias: "specific_competency",
      referencedTable: "specific_competencies",
      isOneToMany: false,
    },
  } as const;

export class ResourceCompetencyController extends QueryController<
  "resource_competencies",
  typeof resourceCompetencyRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type ResourceCompetency = Awaited<
  ReturnType<ResourceCompetencyController["getById"]>
>;
export type ResourceCompetencyInsert = Parameters<
  ResourceCompetencyController["create"]
>[0];
export type ResourceCompetencyUpdate = Parameters<
  ResourceCompetencyController["update"]
>[1];

export const useResourceCompetenciesController: UseControllerHook<
  "resource_competencies",
  typeof resourceCompetencyRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const resourceEvaluationRelationMap: ForeignKeyRelationMap<"resource_evaluations"> =
  {
    resource_evaluations_evaluator_id_fkey: {
      alias: "evaluator",
      referencedTable: "users",
      isOneToMany: false,
    },
    resource_evaluations_resource_id_fkey: {
      alias: "resource",
      referencedTable: "resources",
      isOneToMany: false,
    },
    resource_evaluations_user_id_fkey: {
      alias: "user",
      referencedTable: "users",
      isOneToMany: false,
    },
...
export class ResourceEvaluationController extends QueryController<
  "resource_evaluations",
  typeof resourceEvaluationRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type ResourceEvaluation = Awaited<
  ReturnType<ResourceEvaluationController["getById"]>
>;
export type ResourceEvaluationInsert = Parameters<
  ResourceEvaluationController["create"]
>[0] & { status: "CONFORMABLE" | "UNCONFORMABLE" | "IN_PROGRESS" | null };
export type ResourceEvaluationUpdate = Parameters<
  ResourceEvaluationController["update"]
>[1] & { status: "CONFORMABLE" | "UNCONFORMABLE" | "IN_PROGRESS" | null };

export const useResourceEvaluationsController: UseControllerHook<
  "resource_evaluations",
  typeof resourceEvaluationRelationMap
...
// Resource - Minimal relations for LIST view (optimized for performance)
...
// Resource - Full relations for DETAIL view (all data needed)
...
export const resourceRelationMap = resourceDetailRelationMap;

export const tableResourceRelationMap = resourceListRelationMap;

export class ResourceController extends QueryController<
  "resources",
  typeof resourceRelationMap
> {
  constructor(client: TypedSupabaseClient) {
    super(client, "resources", {
      fields: ["*"], // Default: all fields for detail view
      relationMap: resourceRelationMap,
    });
  }

  // Optimized method for list view with minimal fields
...
export type Resource = Awaited<
  ReturnType<
    QueryController<"resources", typeof resourceRelationMap>["getById"]
  >
>;
export type ResourceInsert = Parameters<
  QueryController<"resources", typeof resourceRelationMap>["create"]
>[0];
export type ResourceUpdate = Parameters<
  QueryController<"resources", typeof resourceRelationMap>["update"]
>[1];

export const useResourcesController: UseControllerHook<
  "resources",
  typeof resourceRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export const useResourcesCrud = () => {
  ...
  return useCrud<"resources", typeof resourceRelationMap>(
    controller,
    "resources"
  );
};
...
export const specificCompetencyRelationMap = {
  specific_competencies_class_id_fkey: {
    alias: "class",
    referencedTable: "classes",
    isOneToMany: false,
  },
  specific_competencies_competency_id_fkey: {
    alias: "competency",
    referencedTable: "general_competencies",
    isOneToMany: false,
    nested: "discipline:disciplines(*)",
  },
} as const;

export class SpecificCompetencyController extends QueryController<
  "specific_competencies",
  typeof specificCompetencyRelationMap
> {
  constructor(client: TypedSupabaseClient) {
...
export type SpecificCompetency = Awaited<
  ReturnType<SpecificCompetencyController["getById"]>
>;
export type SpecificCompetencyInsert = Parameters<
  SpecificCompetencyController["create"]
>[0];
export type SpecificCompetencyUpdate = Parameters<
  SpecificCompetencyController["update"]
>[1];

export const useSpecificCompetenciesController: UseControllerHook<
  "specific_competencies",
  typeof specificCompetencyRelationMap
> = () => {
  const supabase = useSupabaseBrowser();
...
export type ResourceSpecificCompetency = Awaited<
  ReturnType<ResourceSpecificCompetencyController["getById"]>
>;
export type ResourceSpecificCompetencyInsert = Parameters<
  ResourceSpecificCompetencyController["create"]
>[0];
export type ResourceSpecificCompetencyUpdate = Parameters<
  ResourceSpecificCompetencyController["update"]
>[1];

export const resourceSpecificCompetencyRelationMap: ForeignKeyRelationMap<"resource_competency"> =
  {
    resource_competency_competency_id_fkey: {
      alias: "competency",
      referencedTable: "specific_competencies",
      isOneToMany: false,
    },
...
export const useResourceSpecificCompetenciesController: UseControllerHook<
  "resource_competency"
> = () => {
  const supabase = useSupabaseBrowser();
